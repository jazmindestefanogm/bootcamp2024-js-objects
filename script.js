...
document.getElementById('infoForm').addEventListener('submit', function(event) {
    ...
    let intereses = document.getElementById('intereses').value.split(',').map(item => item.trim());
    ...
    persona = {
        ...
        saludar: function() {
            ...
            return `¡Hola! Mi nombre es ${this.nombre} y tengo ${this.edad} años. Soy ${this.profesion} y mis intereses son ${this.intereses.join(', ')}.`;
        }
    };
